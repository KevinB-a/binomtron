...
def add_participants(x):
    """function to add the participant in List"""
    return participants.append(x)

def question_participant():
    """function who ask to user if he want to add more participant """
    participant = input(print("Another one more participant?"))
    return participant
